...
--hud
AddCSLuaFile("core/hud/cl_hud_coroutines.lua")
AddCSLuaFile("core/hud/cl_hud_materials.lua")
AddCSLuaFile("core/hud/cl_hud_sounds.lua")
AddCSLuaFile("core/hud/cl_hud_vars.lua")
AddCSLuaFile("core/hud/cl_hud_fixers.lua")
AddCSLuaFile("core/hud/cl_hud_scientists.lua")
AddCSLuaFile("core/hud/cl_hud_testsubjects.lua")
--shared files
